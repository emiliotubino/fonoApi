...
// Enum for evaluation status (same as anamnesis)
...
export interface ITemplateSnapshot {
  ...
  categories: mongoose.Types.ObjectId[];  // Snapshot of categories at creation time
}
...
// Field schema for template snapshot
